...
| N3 (Fable) | Ícone (sol/lua traço mono) no botão de troca de tema, substituindo o texto `[ TEMA · ... ]` | ✅ feito, verificado e commitado (junto com G1 + R6) | `789a084` |
| G1 (Fable) | Ganhos estimados no Monitor do Rig (1ª composição cross-module: hashrate do rig + da rede + recompensa + preço) | ✅ feito, verificado e commitado (junto com N3 + R6) | `789a084` |
| R6 (Fable) | 3 achados de screenshot: rótulo DARK/WHITE no botão de tema, largura do parágrafo da Bússola = largura da tabela, rodapé com coração pixelado + endereço de doação | ✅ feito, verificado e commitado (junto com N3 + G1) | `789a084` |
...
| R8 (Fable) | Glifo do dark mode: lua pixelada → céu estrelado (achado de uso real — a lua não lia bem no grid grosso) | 📝 **escrito em 2026-07-12** (chat Cowork, direção B escolhida pelo Carlos entre 2 comparadas com mockup via `creative-ui-director`) — pronto pra colar, ver `docs/zephyr-mining-hub-prompts.md` | — |
